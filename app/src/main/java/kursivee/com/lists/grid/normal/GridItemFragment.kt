 ...
 * [GridItemFragment.OnListFragmentInteractionListener] interface.
 */
class GridItemFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_griditem_list, container, false)
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = MyGridItemRecyclerViewAdapter(DummyContent.ITEMS, listener)
            }
        }
        return view
    }
